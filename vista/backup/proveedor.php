...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hierro Perú / Mantenimiento de Proveedores</title>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <p><input type="text" name="txtrazsocial" id="txtrazsocial" class="form-control" placeholder="Razón Social" required=""><p>
                          <p><input type="text" name="txtruc" maxlength="11" id="txtruc" class="form-control" placeholder="RUC" required=""><p>
                          <p><input type="text" name="txtdireccion" id="txtdireccion" class="form-control" placeholder="Direccion" required=""><p>
                      </div>
