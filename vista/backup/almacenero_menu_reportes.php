...
<!--      <li class="treeview transacciones-tree" >
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="producto.php"><i class="fa fa-file-text">Insumos</i></a></li><li class="menu-division"></li>
          <li><a href="proveedor.php"><i class="fa fa-file-text">Proveedores</i></a></li><li class="menu-division"></li>
        </ul>
        <a href="#">
