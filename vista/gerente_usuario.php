                    ...
                    <form class="form-inline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5">
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar" onClick="agregar()" >Agregar Nuevo Usuario</button>
                            </div>
                        </div>
                    </form>
                </div><!-- /.box-header -->
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">  
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="txtdni" id="txtdni" required=""  maxlength="8">
                            </div>
                        </div>                           
                        <div class="row">  
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="txtapep" id="txtapep" required="">
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="txtapem">Apellido Materno</label>
                                <input type="text" class="form-control" name="txtapem" id="txtapem" required="">
                            </div>
                        </div>   
                        <div class="row">  
                        ...
                        <div class="row">  
                            <div class="form-group col-lg-6">
                                ...
                                <input type="email" class="form-control" name="txtemail" id="txtemail" required="" placeholder="nombre@correo.com">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="txtpass">Clave de Usuario</label>
                        ...
                        <div class="row">  
                            ...
                            <div class="form-group col-lg-6">
                                <label for="cmb-cargo">Cargo</label>
                                <select id="cmb-cargo" name="cmb-cargo" class="form-control"></select>
                                <!--<input type="text" class="form-control" id="txtdni">-->
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="cmb-area">Area</label>
                                <select id="cmb-area" name="cmb-area" class="form-control"></select>
                                <!--<input type="text" class="form-control" id="txtdni">-->
                            </div>
                        </div> 
