...
<html>
  ...
  <body class="skin-green">
    ...
    <div class="wrapper">
      ...
      <?php
        include 'fundicion_cabecera.php';
      ?>
      ...
      <aside class="main-sidebar">
        ...
        <?php
            include 'fundicion_menu_reportes.php';
        ?>
        <!-- /.sidebar -->
      </aside>
                    ...
                    <form class="form-inline">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="radio">
                                    <label>
                                      <input type="radio" name="rbtipo" id="rbtipo" value="0" checked="">
                                      Todas las Fechas
                                    </label>
                                </div>
                            </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          <input type="hidden" id="cod_pedido" value="" >
                          <input type="hidden" id="index" value="" >
                          <button type="button" class="btn btn-primary" aria-hidden="true" id="btnatender" onclick="atender()" >Atender Pedido</button>
    ...
    <script src="js/fundicion_pedidos-listar.js?u=5"></script>
