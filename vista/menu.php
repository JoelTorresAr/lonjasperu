...
<!--          <li><a href="#"><i class="fa fa-users"></i> Personal</a></li>-->
          ...
          <li><a href="unidad-medida.php"><i class="fa fa-cogs"></i> Unidad de Medida </a></li>
<!--          <li><a href="#"><i class="fa fa-archive"></i> Sucursales</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="reporte-insumos.php"><i class="fa fa-file-text"></i> Movimientos</a></li>
          <li class="menu-division"></li>
          ...
          <li class="menu-division"></li>
          <li><a href="reporte-producto.php"><i class="fa fa-file-text"></i> Insumos</a></li>
          <li><a href="reporte-compras.php"><i class="fa fa-file-text"></i> Compras</a></li>
          <li><a href="reporte-abc.php"><i class="fa fa-file-text"></i> ABC</a></li>
