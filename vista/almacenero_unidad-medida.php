...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hierro Perú / Mantenimiento de Unidad de Medidas</title>
  ...
  <body class="skin-green">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Agregar nueva unidad de medida</h4>
                      </div>
                      <div class="modal-body">
                          ...
                          <p><input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control" placeholder="Unidad de Medida" maxlength="10" required=""><p> 
                      </div>
    ...
    <script src="js/unidad-medida.js"></script>
