            ...
            <form id="frmgrabar">
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            <button type="submit" class="btn btn-danger btn-sm">Registrar Devolucion</button>
                        </ol>
                    </section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="txtidarea" name="txtidarea" value="">
                                            <input type="text" class="form-control input-sm" id="txtarea" readonly="" required="" value="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-sm" id="txtcantidad" />
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <div class="form-group">
