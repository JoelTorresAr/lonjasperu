function listar(){
    $("#listado").empty();
    $("#listado").load("../controlador/unidad.controlador.php");
...
$("#frmgrabar").submit(function(event){
   ...
   $.post(
           "../controlador/unidad.agregar.editar.controlador.php",
            {
...
function editar(codcargo){
    ...
    $.post(
            "../controlador/unidad.leer.datos.controlador.php",
            {
                codCargo : codcargo
            }
            ).done(function(resultado){
                ...
                $("#txtcodigo").val(datos.idunid);
                $("#txtdescripcion").val(datos.nombre);
...
function eliminar(codigo){
    ...
    $.post(
            "../controlador/unidad.eliminar.controlador.php",
            {
                codunidad : codigo
            }
        ).done(function(resultado){
