...
$("#btnagregar").click(function(){
    ...
    var fila =   "<tr>"+
                     ...
                     "<td style=\"text-align: right\" id=\"cunidad\">" + unidad + "</td>"+
                     "<td hidden style=\"text-align: right\" id=\"cidunidad\">" + idunidad + "</td>"+
...
//        if ( $("#txtdniusuario").val().toString() === "" ){
   ...
   $("#detallepedido tr").each(function(){
       ...
       var idunidad = $(this).find("td").eq(4).html();
...
//    alert(jsonDetalle);
   $.post(
           "../controlador/pedido.controlador.php",
           {
            ...
            if ($.trim(resultado)==="Pedido realizado con exito"){
                document.location.href="fundicion_pedido-listado.php";
            }
           alert(resultado);
