<header class="main-header">
    ...
    <a href="fundicion_menu.php" class="logo"><b>Gestion de Almacen</b></a>
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-12 text-center">
                    <a href="fundicion_cambiar-contrasena.php"><i class="fa fa-key text-primary"></i> <span class="text-primary">Cambiar mi contraseña</span></a>
                  </div>
