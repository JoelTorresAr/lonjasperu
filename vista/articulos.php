    ...
    <!-- INICIO: Contenido de la página -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Hierro Perú / Mantenimiento de artículos
          </h1>
          <ol class="breadcrumb">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <p><input type="text" name="txtnombre" id="txtnombre" class="form-control" placeholder="Nombre del artículo" required=""><p>
                          <p><input type="text" name="txtprecioventa" id="txtprecioventa" class="form-control" placeholder="Precio Venta" required=""><p>
                          <p>
                              <select class="form-control" name="cbomarca_modal" id="cbomarca_modal" required="" >
                               
                              </select>
                          </p>
                          
                          <p>
                              <select class="form-control" name="cbolinea_modal" id="cbolinea_modal" required="" >
                               
                              </select>
                          </p>
                          <p>
                              <select class="form-control" name="cbocategoria_modal" id="cbocategoria_modal" required="" >
