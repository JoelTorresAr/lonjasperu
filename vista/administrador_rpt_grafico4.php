...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'IMPORTES DE COMPRAS POR AÑOS en 3D'
        },
        subtitle: {
            text: 'Entre los años 2017 y 2012'
        },
        plotOptions: {
            column: {
                depth: 25
...
?>
  ...
  <body class="skin-green">
    ...
    <div class="wrapper">
      ...
      <?php   include 'administrador_cabecera.php';    ?>
      ...
      <aside class="main-sidebar">
        ...
        <?php
            include 'administrador_menu_reportes.php';
        ?>
        <!-- /.sidebar -->
      </aside>
