...
<html>
  <head>
    ...
    <link href="../util/bootstrap/css/img-background.css" rel="stylesheet" type="text/css" />
    <!--Image Background-->
    <link href="../util/bootstrap/css/img-background.css" rel="stylesheet" type="text/css"/>
  ...
  <body class="login-page">
    ...
    <div class="login-box">        
      <div class="login-logo">        
        <a href="../../index2.html"><b>Sistema de Almacen</b></a>
        <img class="img-responsive center-block" src="../imagenes/inicio.jpg" class="img-rounded">
      </div><!-- /.login-logo -->
