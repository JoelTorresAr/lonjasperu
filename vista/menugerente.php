...
<!--      <li class="treeview transacciones-tree" >
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="reporte-usuariosgerencia.php"><i class="fa fa-file-text"></i> Usuarios</a></li>
          <li class="menu-division"></li>
          <li><a href="reporte-pedidos-atendidosgerencia.php"><i class="fa fa-file-text"></i> Pedidos Atendidos</a></li>
          <li><a href="reporte-pedidos-noatendidosgerencia.php"><i class="fa fa-file-text"></i> Pedidos no Atendidos</a></li>
          <li class="menu-division"></li>
          <li><a href="reporte-productogerencia.php"><i class="fa fa-file-text"></i> Almacen</a></li>
          <li><a href="reporte-comprasgerencia.php"><i class="fa fa-file-text"></i> Compras</a></li>
