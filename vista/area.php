...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hierro Perú / Mantenimiento de Área</title>
  ...
  <body class="skin-green">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Agregar nuevo Área</h4>
                      </div>
                      <div class="modal-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-xs-10">
                                  <p><input type="text" name="txtnombre" id="txtnombre" class="form-control" placeholder="Nombre del Area" required=""></p>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-xs-2">
                              ...
                              <div class="col-xs-10">
                                  <p><input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control" placeholder="Descripcion" required=""></p>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-xs-2">
                              ...
                              <div class="col-xs-10">
                                  <select class="form-control" name="cmb-encargado" id="cmb-encargado" required="" >
    ...
    <script src="js/area.js?x=3"></script>
